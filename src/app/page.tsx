  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-4 md:px-32">
      ...
      <footer className="w-full">
        <div className="w-full max-w-[91%] flex flex-col lg:flex-row items-center justify-between mx-auto uppercase text-[13px] lg:text-[1.1rem] tracking-[0.5px] text-center lg:space-x-4 space-y-2 lg:space-y-0">
