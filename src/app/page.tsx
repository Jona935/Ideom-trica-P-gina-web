...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-4 md:px-32">
      ...
      <EtherealCanvas />
      <div className="relative z-10 justify-center text-center text-foreground pointer-events-none mt-16 md:mt-0">
        <h1 className="md:px-[10rem] text-2xl md:text-4xl font-headline font-bold h-[15rem]">
           <TypeIt
              key={locale}
              options={{
